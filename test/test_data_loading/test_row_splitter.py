...
class TestRowSplitter(unittest.TestCase):
    ...
    def test_row_that_doesnt_need_splitting(self):
        ...
        self.assertEqual([test_row], _split_row_into_multiple_responses(test_row))

    def test_row_with_one_split(self):
        test_row = {'Q1': 23, '1_Q2_Something': 'alligators', '2_Q2_Something': 'crocodiles'}
        expected = [
            {'Q1': 23, 'Q2_Something': 'alligators'},
            {'Q1': 23, 'Q2_Something': 'crocodiles'}
        ]
        self.assertEqual(expected, _split_row_into_multiple_responses(test_row))
    ...
    def test_row_with_multiple_splits(self):
        ...
        expected = [
            {'Q1': 23, 'Q2_Something': 'alligators'},
            {'Q1': 23, 'Q2_Something': 'crocodiles'},
            {'Q1': 23, 'Q2_Something': 'lizards'},
            {'Q1': 23, 'Q2_Something': 'dragons'}
        ]
        self.assertEqual(expected, _split_row_into_multiple_responses(test_row))
    ...
    def test_only_splits_rows_with_non_null_responses(self):
        ...
        expected = [
            {'Q1': 23, 'Q2_Something': 'alligators', 'Q3': 'chickens'},
            {'Q1': 23, 'Q2_Something': 'crocodiles', 'Q3': 'roosters'},
            {'Q1': 23, 'Q2_Something': '', 'Q3': 'hens'}
        ]
        self.assertEqual(expected, _split_row_into_multiple_responses(test_row))
    ...
    def test_row_with_no_multi_question_responses(self):
        ...
        expected = [{'Q1': 23, 'Q2_Something': '', 'Q3': '', 'Q4': 'forty-two'}]
        self.assertEqual(expected, _split_row_into_multiple_responses(test_row))
    ...
    def test_split_multiple_rows(self):
        ...
        expected = [
            ...
            {'Q1': 23, 'Q2_Something': 'crocodiles', 'Q3': 'roosters'},
            {'Q1': 23, 'Q2_Something': '', 'Q3': 'hens'},
            {'Q1': 98, 'Q2_Something': 'dragons', 'Q3': 'hawks'},
            {'Q1': 98, 'Q2_Something': 'bearded dragons', 'Q3': ''},
            {'Q1': 2135, 'Q2_Something': 'Octapus', 'Q3': 'Carrot'},
        ]
        self.assertEqual(expected, split_response_rows(test_rows))
